...
const SupplierRelationships: React.FC<SupplierRelationshipsProps> = ({ 
  ...
  const [selectedRelationship, setSelectedRelationship] = useState<CompanySellingPoint | null>(null);
  ...
  return (
    <>
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Conferma Terminazione Relazione</AlertDialogTitle>
            <AlertDialogDescription>
              Sei sicuro di voler terminare questa relazione? Verrà impostata la data di fine a oggi.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
